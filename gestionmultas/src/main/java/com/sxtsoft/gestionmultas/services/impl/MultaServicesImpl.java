package com.sxtsoft.gestionmultas.services.impl;
...
import com.sxtsoft.gestionmultas.services.MultaServices;
...
public class MultaServicesImpl implements MultaServices {
	...
	public Multa create(Multa multa) {
		...
		if (multa.getCodigo() != null) {
			throw new IllegalArgumentException("El codigo ha de ser nulo");
		}
